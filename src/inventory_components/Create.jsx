...
const Create = () => {
    ...
    // a function that respond when the form is submitted
    function handle_submit(e){
        ...
        if(form.name == "" || form.price == ""){
            ...
            setForm({...form, id: id});
            // console.log(data)
            /// send what we collected from the form to an api that will insert it into database. The api sends a response and we update our state like below
